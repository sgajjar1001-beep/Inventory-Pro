                  ...
                  return (
                    <tr key={q.id} className="hover:bg-slate-50/55 transition-colors">
                      ...
                      <td className="px-4 py-3.5 whitespace-nowrap">
                        <div className="text-slate-500">M: {q.mfgDate ? q.mfgDate.split('-').reverse().join('-') : 'N/A'}</div>
                        <div className="text-slate-800 font-bold">E: {q.expDate ? q.expDate.split('-').reverse().join('-') : 'N/A'}</div>
                      </td>
                      ...
                      <td className="px-4 py-3.5 text-center whitespace-nowrap">
                        {q.qcStatus === 'Pending' ? (
                          ...
                          <div className="text-[10px] text-slate-400 font-medium italic">
                            Decided {q.qcReleaseDate ? `on ${q.qcReleaseDate.split('T')[0].split('-').reverse().join('-')}` : ''}
                          </div>
                        )}
                      </td>
                    </tr>
