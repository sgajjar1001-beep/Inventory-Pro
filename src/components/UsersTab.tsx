    ...
    <div className="space-y-6 animate-fade-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-slate-800 bg-stone-50 border border-stone-200 text-xs p-2.5 outline-none rounded-xl focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition focus:bg-white"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full text-slate-800 bg-stone-50 border border-stone-200 text-xs p-2.5 outline-none rounded-xl focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
                >
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full text-slate-800 bg-stone-50 border border-stone-200 text-xs p-2.5 pr-10 outline-none rounded-xl focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition focus:bg-white font-mono"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                className="w-full flex justify-center items-center gap-1.5 py-2.5 px-4 border border-transparent rounded-xl shadow-xs text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 active:scale-98 transition cursor-pointer"
              >
                <ShieldPlus className="w-4 h-4 text-sky-200" /> Register Credentials
              </button>
            </form>
          )}
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-stone-200/55 shadow-xs col-span-2 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {users.map(u => (
              <div 
                key={u.id}
                className="border border-slate-200 bg-slate-50/50 p-4 rounded-xl flex items-start gap-3 shadow-xs hover:border-slate-300 transition"
              >
                <div className="bg-blue-50 p-2.5 rounded-xl text-blue-600 border border-stone-200/55 shrink-0">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-stone-500 font-mono">
                    ID Username: <b className="text-blue-600 text-xs font-bold">{u.username}</b>
                  </p>
                  <p className="text-[10px] text-stone-500 font-mono">
          ...
          <div className="pt-4 border-t border-stone-200/50 p-3.5 bg-slate-50 rounded-xl border border-slate-200">
            <h4 className="text-xs font-bold text-blue-600">💡 Dynamic Sync Note:</h4>
      ...
      <div className="bg-white p-5 rounded-2xl border border-stone-200/55 shadow-xs space-y-4">
        <div className="flex items-center justify-between border-b border-stone-100 pb-3">
          ...
          <span className="text-[10px] bg-slate-50 border border-stone-200 px-2.5 py-1 rounded-lg font-mono text-slate-600 font-bold shadow-2xs">
              ...
              <div key={act.id} className="flex gap-3 text-xs items-start p-3 bg-stone-50/50 hover:bg-stone-50 rounded-xl border border-stone-100 transition duration-100">
                ...
                <div className="space-y-1 w-full min-w-0">
                  ...
                  <p className="text-[10px] text-blue-600 font-semibold flex items-center gap-1">
                    ...
                    <span className="bg-blue-50/70 text-blue-600 border border-blue-100/40 px-1.5 py-0.5 rounded font-mono font-extrabold uppercase text-[9px]">{act.operator}</span>
                  </p>
                </div>
              </div>
            ));
