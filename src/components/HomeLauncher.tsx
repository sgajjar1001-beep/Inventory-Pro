...
export default function HomeLauncher({ 
  ...
  const filteredMenuTiles = menuTiles.filter(tile => tile.id !== 'qc' || qcEnabled);

  const inwardEnabled = localStorage.getItem('cfg_inward_enabled') !== 'false';
  const outwardEnabled = localStorage.getItem('cfg_outward_enabled') !== 'false';
  const showTransactionCenter = inwardEnabled || outwardEnabled;

  return (
    <div className="space-y-6 animate-fade-in py-1 max-w-6xl mx-auto px-4">

      {/* Featured Side-By-Side ("aju baju") Action Hub */}
      {showTransactionCenter && (
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className={`text-[10px] font-mono mt-0.5 uppercase tracking-wider ${
                        ...
                        Total: {grns.length} records filed • Open Register
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className={`text-[10px] font-mono mt-0.5 uppercase tracking-wider ${
                        ...
                        Total: {outwards.length} issued tasks • Open Register
                      </p>
                    </div>
                  </div>
