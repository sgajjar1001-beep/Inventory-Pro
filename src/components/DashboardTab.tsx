    ...
    <div className="space-y-6 animate-fade-in font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div 
          ...
          className="bg-white border border-stone-200/80 rounded-2xl p-4 shadow-xs hover:border-blue-600 transition group cursor-pointer flex flex-col justify-between min-h-[120px]"
        >
          <div className="flex justify-between items-start">
            <span className="text-[10px] uppercase font-extrabold tracking-wider text-slate-500 group-hover:text-blue-600 transition">
        ...
        <div 
          className={`bg-white border border-stone-200/80 rounded-2xl p-4 shadow-xs hover:border-blue-600 transition flex flex-col justify-between min-h-[120px] relative ${outwardExpanded ? 'ring-2 ring-blue-600/40' : ''}`}
        >
          <div className="flex justify-between items-start">
            ...
            <button
              ...
              className="bg-blue-50 hover:bg-blue-100 hover:scale-105 text-blue-600 p-1.5 rounded-lg border border-blue-100 transition flex items-center gap-1 cursor-pointer absolute right-4 top-4"
          ...
          <div
            ...
            className="text-[9px] text-slate-600 font-black hover:text-blue-600 transition cursor-pointer mt-2 leading-none"
          >
      ...
      {materials.length > 0 && (
        <div className="bg-white border border-stone-200/80 rounded-2xl p-4 shadow-3xs space-y-3">
          <div className="flex justify-between items-center border-b border-stone-100 pb-2">
            ...
            <span className="text-[9px] font-black uppercase text-amber-700 bg-amber-500/5 px-2 py-0.5 rounded border border-amber-500/10">
              Auto Monitored
            </span>
          </div>
